...
function branded_process_css($css, $theme) {
    ...
    $css = branded_set_regionwidth($css, $regionwidth);
    ...
    $css = branded_set_customcss($css, $customcss);
 ...
 * @return string
 */
function branded_set_regionwidth($css, $regionwidth) {
 ...
 * @return string
 */
function branded_set_customcss($css, $customcss) {
